...
const { getStudents, getStudentById, postNewStudent, updateStudent, getAllStudentRecordsById } = require('./controllers/students.controller');
...
app.get('/api/students/allRecords/:studentId',getAllStudentRecordsById)
